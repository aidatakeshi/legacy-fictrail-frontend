        ...
        :title="isNew ? '新增項目' : '編輯項目'">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-lg-4">
                    <b-form-input type="text" v-model="editing.id" :disabled="!isNew && !isCopy" size="sm"
                    @focus="editing_failed = false" />
                </div>
                <div class="col-sm-4 col-lg-2">組別</div>
                <div class="col-sm-8 col-lg-4">
                    <select-item type="vehicle_performance_group" v-model="editing.group_id" size="sm"
                    @focus="editing_failed = false" />
                </div>
                <div class="col-sm-12 col-lg-2">名稱</div>
                <div class="col-sm-12 col-lg-10">
                    <b-form-input type="text" v-model="editing.name_chi" size="sm"
                    @focus="editing_failed = false" />
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-xl-3">
                    <b-form-input type="text" v-model="editing.motor_ratio" size="sm"
                    @focus="editing_failed = false" />
                </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <b-form-input type="text" v-model="editing.motor_rated_kw" size="sm"
                    @focus="editing_failed = false" />
                </div>
                <div class="col-sm-12 col-xl-6 text-secondary" style="font-size: 80%">
                ...
                <div class="col-sm-6 col-xl-3">
                    <b-form-input type="text" v-model="editing.motor_overclock_ratio" size="sm"
                    @focus="editing_failed = false" />
                </div>
                <div class="col-sm-12 col-xl-6 text-secondary" style="font-size: 80%">
                ...
                <div class="col-sm-6 col-xl-3">
                    <b-form-input type="text" v-model="editing.crush_capacity" size="sm"
                    @focus="editing_failed = false" />
                </div>
                <div class="col-sm-12 col-xl-6 text-secondary" style="font-size: 80%">
                ...
                <div class="col-sm-6 col-xl-3">
                    <b-form-input type="text" v-model="editing.empty_mass_avg_t" size="sm"
                    @focus="editing_failed = false" />
                </div>
                <div class="col-sm-12 col-xl-6 text-info" style="font-size: 80%">
                    滿員時重量為 {{crush_mass_t}} t。
                </div>
                <div class="col-sm-6 col-xl-3">
                    最高速度 (km/h)
                </div>
                <div class="col-sm-6 col-xl-3">
                    <b-form-input type="text" v-model="editing.max_speed_kph" size="sm"
                    @focus="editing_failed = false" />
                </div>
                <div class="col-sm-12 col-xl-6 text-secondary" style="font-size: 80%">
                </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <b-form-input type="text" v-model="editing.max_accel_kph_s" size="sm"
                    @focus="editing_failed = false" />
                </div>
                <div class="col-sm-12 col-xl-6 text-info" style="font-size: 80%">
                    滿員時定加速度上限為 {{const_accel_max_kph.toFixed(1)}} km/h。
                </div>
                <div class="col-sm-6 col-xl-3">
                    100km/h時加速度損失 (線性)
                </div>
                <div class="col-sm-6 col-xl-3">
                    <b-form-input type="text" v-model="editing.resistance_loss_per_100kph" size="sm"
                    @focus="editing_failed = false" />
                </div>
                <div class="col-sm-12 col-xl-6 text-secondary" style="font-size: 80%">
                ...
                <div class="col-sm-6 col-xl-3">
                    <b-form-input type="text" v-model="editing.resistance_loss_per_100kph_q" size="sm"
                    @focus="editing_failed = false" />
                </div>
                <div class="col-sm-12 col-xl-6 text-secondary" style="font-size: 80%">
                ...
                <div class="col-sm-6 col-xl-3">
                    <b-form-input type="text" v-model="editing.const_power_accel_ratio" size="sm"
                    @focus="editing_failed = false" />
                </div>
                <div class="col-sm-12 col-xl-6 text-info" style="font-size: 80%">
                    滿員時定出力上限為 {{const_power_max_kph.toFixed(1)}} km/h。
                </div>
                <div class="col-sm-6 col-xl-3">
                    最高減速度 (km/h/s)
                </div>
                <div class="col-sm-6 col-xl-3">
                    <b-form-input type="text" v-model="editing.max_decel_kph_s" size="sm"
                    @focus="editing_failed = false" />
                </div>
                <div class="col-sm-12 col-xl-6 text-secondary" style="font-size: 80%">
                ...
                <div class="col-sm-6 col-xl-3">
                    <b-form-input type="text" v-model="editing.min_decel_kph_s" size="sm"
                    @focus="editing_failed = false" />
                </div>
                <div class="col-sm-12 col-xl-6 text-secondary" style="font-size: 80%">
                </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <b-form-input type="text" v-model="editing.const_decel_max_kph" size="sm"
                    @focus="editing_failed = false" />
                </div>
                <div class="col-sm-12 col-xl-6 text-secondary" style="font-size: 80%">
                ...
                <div class="col-sm-6 col-xl-3">
                    <b-form-input type="text" v-model="editing.depart_additional_time_s" size="sm"
                    @focus="editing_failed = false" />
                </div>
                <div class="col-sm-12 col-xl-6 text-secondary" style="font-size: 80%">
                    關門至開車之間的所要時間。
