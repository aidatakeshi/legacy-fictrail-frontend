...
const data_handling = require('~/map-new-data-handling.js');
    ...
    <div>
        <div class="map-overlay" :hidden="chooseStationMode">
            ...
            <div class="mb-2 d-flex align-items-center">
                ...
                <b-button variant='outline-secondary' @click="$refs.line_modal.show()">
                    <b-icon-pen />
                </b-button>
            </div>
            ...
            <b-modal ref="line_modal" centered scrollable hide-footer :title="value$.name_chi" size="xl"
            @show="modal_showing = true" @hide="modal_showing = false">
                <lines-view-stations :line-id="value$.id" v-if="modal_showing" />
            </b-modal>
        </div>
        <!-- Choose Station Mode -->
